...
parser.add_argument('--use_headlines', default=1, type=int, help="whether to train on headlines or not" )
parser.add_argument('--use_body', default=0, type=int, help="whether to train on headlines or not" )
